...
CREATE TABLE "new_policies" (
    ...
    "targetContainer" TEXT DEFAULT 'mkv',
    "skipReencoding" BOOLEAN NOT NULL DEFAULT true,
...
INSERT INTO "new_policies" ("advancedSettings", "atomicReplace", "createdAt", "deviceProfiles", "id", "libraryId", "name", "preset", "skipSeeding", "targetCodec", "targetQuality", "updatedAt", "verifyOutput") SELECT "advancedSettings", "atomicReplace", "createdAt", "deviceProfiles", "id", "libraryId", "name", "preset", "skipSeeding", "targetCodec", "targetQuality", "updatedAt", "verifyOutput" FROM "policies";
DROP TABLE "policies";
