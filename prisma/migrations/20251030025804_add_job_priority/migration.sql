...
INSERT INTO "new_jobs" ("afterSizeBytes", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "failedAt", "fileLabel", "filePath", "fps", "healthCheckRetries", "healthCheckStartedAt", "healthCheckedAt", "healthMessage", "healthScore", "healthStatus", "id", "isBlacklisted", "libraryId", "nextRetryAt", "nodeId", "policyId", "progress", "retryCount", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "targetCodec", "updatedAt") SELECT "afterSizeBytes", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "failedAt", "fileLabel", "filePath", "fps", "healthCheckRetries", "healthCheckStartedAt", "healthCheckedAt", "healthMessage", "healthScore", "healthStatus", "id", "isBlacklisted", "libraryId", "nextRetryAt", "nodeId", "policyId", "progress", "retryCount", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "targetCodec", "updatedAt" FROM "jobs";
DROP TABLE "jobs";
