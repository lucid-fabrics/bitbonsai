...
CREATE TABLE "job_history" (
    ...
    CONSTRAINT "job_history_jobId_fkey" FOREIGN KEY ("jobId") REFERENCES "jobs" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
INSERT INTO "new_jobs" ("afterSizeBytes", "autoHealedAt", "autoHealedProgress", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "failedAt", "fileLabel", "filePath", "fps", "healthCheckRetries", "healthCheckStartedAt", "healthCheckedAt", "healthMessage", "healthScore", "healthStatus", "id", "isBlacklisted", "keepOriginalRequested", "lastProgressUpdate", "libraryId", "nextRetryAt", "nodeId", "originalBackupPath", "originalSizeBytes", "policyId", "priority", "prioritySetAt", "progress", "replacementAction", "resumeTimestamp", "retryCount", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "targetCodec", "tempFilePath", "updatedAt") SELECT "afterSizeBytes", "autoHealedAt", "autoHealedProgress", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "failedAt", "fileLabel", "filePath", "fps", "healthCheckRetries", "healthCheckStartedAt", "healthCheckedAt", "healthMessage", "healthScore", "healthStatus", "id", "isBlacklisted", "keepOriginalRequested", "lastProgressUpdate", "libraryId", "nextRetryAt", "nodeId", "originalBackupPath", "originalSizeBytes", "policyId", "priority", "prioritySetAt", "progress", "replacementAction", "resumeTimestamp", "retryCount", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "targetCodec", "tempFilePath", "updatedAt" FROM "jobs";
DROP TABLE "jobs";
...
-- CreateIndex
CREATE INDEX "job_history_jobId_idx" ON "job_history"("jobId");

-- CreateIndex
CREATE INDEX "job_history_eventType_idx" ON "job_history"("eventType");

-- CreateIndex
CREATE INDEX "job_history_createdAt_idx" ON "job_history"("createdAt");

-- CreateIndex
CREATE INDEX "job_history_jobId_createdAt_idx" ON "job_history"("jobId", "createdAt");
