...
INSERT INTO "new_jobs" ("afterSizeBytes", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "fileLabel", "filePath", "healthCheckRetries", "healthCheckedAt", "healthMessage", "healthScore", "healthStatus", "id", "isBlacklisted", "libraryId", "nodeId", "policyId", "progress", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "targetCodec", "updatedAt") SELECT "afterSizeBytes", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "fileLabel", "filePath", "healthCheckRetries", "healthCheckedAt", "healthMessage", "healthScore", "healthStatus", "id", "isBlacklisted", "libraryId", "nodeId", "policyId", "progress", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "targetCodec", "updatedAt" FROM "jobs";
DROP TABLE "jobs";
