...
INSERT INTO "new_jobs" ("afterSizeBytes", "autoHealedAt", "autoHealedProgress", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "failedAt", "ffmpegThreads", "fileLabel", "filePath", "fps", "healingPointSeconds", "healthCheckRetries", "healthCheckStartedAt", "healthCheckedAt", "healthMessage", "healthScore", "healthStatus", "id", "isBlacklisted", "keepOriginalRequested", "lastProgressUpdate", "libraryId", "nextRetryAt", "nodeId", "originalBackupPath", "originalSizeBytes", "policyId", "previewImagePaths", "priority", "prioritySetAt", "progress", "replacementAction", "resourceThrottleReason", "resourceThrottled", "resumeTimestamp", "retryCount", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "startedFromSeconds", "targetCodec", "tempFilePath", "updatedAt", "warning") SELECT "afterSizeBytes", "autoHealedAt", "autoHealedProgress", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "failedAt", "ffmpegThreads", "fileLabel", "filePath", "fps", "healingPointSeconds", "healthCheckRetries", "healthCheckStartedAt", "healthCheckedAt", "healthMessage", "healthScore", "healthStatus", "id", "isBlacklisted", "keepOriginalRequested", "lastProgressUpdate", "libraryId", "nextRetryAt", "nodeId", "originalBackupPath", "originalSizeBytes", "policyId", "previewImagePaths", "priority", "prioritySetAt", "progress", "replacementAction", "resourceThrottleReason", "resourceThrottled", "resumeTimestamp", "retryCount", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "startedFromSeconds", "targetCodec", "tempFilePath", "updatedAt", "warning" FROM "jobs";
DROP TABLE "jobs";
