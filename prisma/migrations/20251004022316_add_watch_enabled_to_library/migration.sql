...
INSERT INTO "new_libraries" ("createdAt", "enabled", "id", "lastScanAt", "mediaType", "name", "nodeId", "path", "totalFiles", "totalSizeBytes", "updatedAt") SELECT "createdAt", "enabled", "id", "lastScanAt", "mediaType", "name", "nodeId", "path", "totalFiles", "totalSizeBytes", "updatedAt" FROM "libraries";
