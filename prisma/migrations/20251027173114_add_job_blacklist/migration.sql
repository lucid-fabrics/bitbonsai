...
INSERT INTO "new_jobs" ("afterSizeBytes", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "fileLabel", "filePath", "id", "libraryId", "nodeId", "policyId", "progress", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "targetCodec", "updatedAt") SELECT "afterSizeBytes", "beforeSizeBytes", "completedAt", "createdAt", "error", "etaSeconds", "fileLabel", "filePath", "id", "libraryId", "nodeId", "policyId", "progress", "savedBytes", "savedPercent", "sourceCodec", "stage", "startedAt", "targetCodec", "updatedAt" FROM "jobs";
DROP TABLE "jobs";
