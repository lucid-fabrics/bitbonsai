...
INSERT INTO "new_nodes" ("acceleration", "apiKey", "cpuLimit", "createdAt", "id", "lastHeartbeat", "licenseId", "maxWorkers", "name", "pairingExpiresAt", "pairingToken", "role", "status", "updatedAt", "uptimeSeconds", "version") SELECT "acceleration", "apiKey", "cpuLimit", "createdAt", "id", "lastHeartbeat", "licenseId", "maxWorkers", "name", "pairingExpiresAt", "pairingToken", "role", "status", "updatedAt", "uptimeSeconds", "version" FROM "nodes";
DROP TABLE "nodes";
