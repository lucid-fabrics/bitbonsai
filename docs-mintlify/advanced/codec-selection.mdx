...
<Note>
**New to video encoding?** A codec is the format used to compress video. See the [codec glossary entry](/glossary#codec) for a simple explanation.
</Note>
...
NVIDIA RTX 20/30/40 series, Intel 6th gen+, or AMD RX 6000+ [GPUs](/glossary#gpu) provide 3-10x speedup with NVENC/QSV/VCE [hardware acceleration](/glossary#hardware-acceleration).
</Card>
...
<Tip>
Enable [hardware acceleration](/glossary#hardware-acceleration) in **Settings → Encoding** to unlock [GPU](/glossary#gpu) speeds. [HEVC](/glossary#codec) on NVIDIA RTX 3060+ provides near-identical quality to CPU at 5-10x the speed.
</Tip>
...
<Info>
**BitBonsai default: [CRF](/glossary#crf) 23** for both [HEVC](/glossary#codec) and AV1. This provides transparent quality indistinguishable from the source for most content.
</Info>
...
<Tip>
**How to adjust [CRF](/glossary#crf):** Settings → Encoding → Quality → CRF slider. Lower for archival quality, higher for streaming/mobile [libraries](/glossary#library).
</Tip>
...
<Note>
**What is hardware transcoding?** Using your graphics card to encode videos 5-10x faster than CPU-only encoding. See [hardware acceleration](/glossary#hardware-acceleration) in the glossary.
</Note>
