...
<Steps>
  ...
  <Step title="Add Path Mappings">
    ...
    | `/media` | `/mnt/user/media` | Read/Write | Media libraries (adjust to your path) |
  </Step>
...
3. Back up and recreate the DB if needed:
   ...
   <Warning>
   Deleting the postgres data directory permanently removes all job history and settings. Backup first.
   </Warning>
