...
<Steps>
  <Step title="Run Docker Compose">
    ...
    Replace `/path/to/your/videos` with your actual video library path. Change `changeme` to a secure password.

    <Warning>
    Update `POSTGRES_PASSWORD` and `DATABASE_URL` to use the same secure password before running.
    </Warning>
...
- **[Docker Installation Guide](/installation/docker)** - Full configuration: GPU, resource limits, logging
...
- **[System Requirements](/installation/requirements)** - Hardware and software prerequisites
